...
class equations:
    ...
    def dXdt(self, X, t):
        ...
        if 'nVDCC' in self.models:
            dCa += 1*nVDCC_O
            dnVDCC_C0 = + n_b1(self.V)*nVDCC_C1 - n_a1(self.V)*nVDCC_C0
            dnVDCC_C1 = + n_a1(self.V)*nVDCC_C0 + n_b2(self.V)*nVDCC_C2 \
                        -(n_b1(self.V) + n_a2(self.V))*nVDCC_C1
            dnVDCC_C2 = + n_a2(self.V)*nVDCC_C1 + n_b3(self.V)*nVDCC_C3 \
                        -(n_b2(self.V) + n_a3(self.V))*nVDCC_C2
            dnVDCC_C3 = + n_a3(self.V)*nVDCC_C2 + n_b4(self.V)*nVDCC_C4 \
                        -(n_b3(self.V) + n_a4(self.V))*nVDCC_C3
        ...
        if 'rVDCC' in self.models:
            ...
            drVDCC_C3 = + r_a3(self.V)*rVDCC_C2 + r_b4(self.V)*rVDCC_C4 \
